...
public:
   ...
   {
      HX_STACK_PUSH("GC", "collect", "GC::collect", __FILE__, __LINE__)
      #ifdef ANDROID
...
{
   HX_STACK_PUSH("GC", "new", "GC::new", __FILE__, __LINE__)
...
void *InternalRealloc(void *inData,int inSize)
{
   ...
   HX_STACK_PUSH("GC", "realloc", "GC::relloc", __FILE__ , __LINE__)
